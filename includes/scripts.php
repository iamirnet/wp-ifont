...
/*function iamir_net_style(){
    wp_enqueue_style('iamir_net-style', plugin_dir_url(__DIR__) . 'assets/css/styles.css',array('theme-style'));
}

add_action('wp_enqueue_scripts', 'iamir_net_style');*/

function iamir_net_scripts() {
    wp_enqueue_style( 'style', get_stylesheet_uri() );
    wp_enqueue_style('iamir_net-style', plugin_dir_url(__DIR__) . 'assets/css/styles.css',array(), '1.1', 'all');
    wp_enqueue_script( 'iamir_net-script', plugin_dir_url(__DIR__) . 'assets/js/script.js', array ( 'jquery' ), 1.1, true);
    ;
...
function iamir_net_admin_style() {
    ...
    wp_register_style('iamir_net_reg_admin_style', plugin_dir_url(__DIR__) . 'assets/css/admin.css');
